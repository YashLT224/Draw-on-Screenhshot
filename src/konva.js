...
const ReactkonvaDraw = () => {
  ...
  return (
    ...
    <div style={{backgroundColor:'brown' , width:'50%', height:'100vh',overflow:'auto',paddingTop:'20px'}}>
      ...
      <img id="img" ref={imageRef} style={{maxWidth:'100%', height:'auto'}} src={fullpage} alt='d'/>
      <div id="abc" 
       style={{
        position: 'absolute',
      ...
      // style={{position:'absolute', backgroundColor:'transparent',top:'0', width:'100%', height:'100%'}}
      >
         <Stage
